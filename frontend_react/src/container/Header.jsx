  ...
  return (
    ...
    >
      <motion.div
        ...
        className="md:pt-[170px] pt-[100px] md:gap-10 px-5 pb-5 flex flex-col-reverse md:flex-row md:bg-none bg-backgroundImgSmNew bg-cover bg-center"
      >
        <div className=" flex-1 mx-auto">
          <img src={images.code1} alt="richard" className="h-72 w-full  shadow-primary shadow-md dark:shadow-white dark:shadow-md border border-primary dark:border-primary bg-white dark:bg-opacity-5 dark:border-opacity-20 border-opacity-20 backdrop-blur-sm rounded-full md:w-full bg-opacity-10 object-cover" />
        </div>
