    ...
    >
      ...
      >
        <div className=" flex-1 mx-auto">
          <LazyLoadImage effect="blur" placeholderSrc={images.code1reduced} src={images.code2} alt="richard" className="md:h-96 h-72 w-full shadow-primary shadow-md dark:shadow-white dark:shadow-md border border-primary dark:border-primary bg-white dark:bg-opacity-5 dark:border-opacity-20 border-opacity-20 backdrop-blur-sm rounded-full bg-opacity-10 object-cover" />
        </div>
