  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <img src={avatarrest} alt="meanimated" className="flex w-11 h-11 mx-auto object-cover mb-4 max-w-[70px] max-h-[70px] shadow-primary dark:shadow-white shadow-sm rounded-full" />
